...
## Project Structure
    ...
    ├── testapiautoteammemb_86421  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_86421`
...
2. Clone this repo and `cd testapiautoteammemb_86421`
